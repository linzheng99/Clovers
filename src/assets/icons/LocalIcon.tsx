export const LocalIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 48 48">
    <defs>
      <mask id="ipSLocal0">
        <g fill="none" strokeLinejoin="round" strokeWidth="4">
          <path stroke="#fff" strokeLinecap="round" d="M9.858 32.757C6.238 33.843 4 35.343 4 37c0 3.314 8.954 6 20 6s20-2.686 20-6c0-1.657-2.239-3.157-5.858-4.243" />
    ...
    <path fill="currentColor" d="M0 0h48v48H0z" mask="url(#ipSLocal0)" />
  </svg>
)
